...
程式範例:1. <a href="https://github.com/GwoChuanLee/Colab-Introduction-Workshop/blob/main/Yolov3 using Darnet on Colab.ipynb">Yolo3 using Darknet on Colab.ipynb [包含安裝 Darknet 過程]</a> <br>
